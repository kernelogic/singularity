...
preparation.command('create').description('Start deal preparation for a local dataset')
  ...
  .option('-l, --scan-limit <scan_limit>', 'Max number of cars in this preparation. 0 means unlimited', '0')
...
replication.command('start')
  ...
  .option('-d, --duration <duration>', 'Duration in days for deal length.', '530')
